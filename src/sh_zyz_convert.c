...
void zyz_to_sh(const double *zyz, double *out) {
  ...
  tt32=sin(tt26);
  tt33=-tt1*tt10*tt3*tt6/8.0-tt1*tt10*tt3*tt4/8.0;
  tt34=2*cc;
  tt35=cos(tt34);
  tt36=-tt10*tt16*tt18/4.0+tt13*tt15/2.0+tt1*tt12/4.0;
  tt37=sin(tt34);
  tt38=tt22*tt1*tt10*tt3*tt24+3*tt22*tt1*tt10*tt3*tt23;
  tt39=cos(cc);
...
void zyz_to_sh_jac(const double *zyz, double *out) {
  ...
  tt29=sin(tt23);
  tt30=sqrt(7);
  tt31=-tt1*tt30*tt3*tt6/2.0-tt1*tt30*tt3*tt4/2.0;
  tt32=2*cc;
  tt33=cos(tt32);
  tt34=tt1*tt30*tt11*tt15/8.0+tt1*tt30*tt11*tt13/2.0-tt10*tt30*tt11/8.0;
  tt35=sin(tt32);
  tt36=tt19*tt1*tt30*tt3*tt21+3*tt19*tt1*tt30*tt3*tt20;
  tt37=cos(cc);
  ...
  tt50=3*tt44*tt1*tt30*tt11*tt6+3*tt44*tt1*tt30*tt11*tt4;
  ...
  tt58=-tt1*tt30*tt11*tt6/8.0-tt1*tt30*tt11*tt4/8.0;
  tt59=-tt19*tt30*tt42*tt27-tt19*tt41*tt25;
  tt60=tt44*tt1*tt30*tt11*tt21+3*tt44*tt1*tt30*tt11*tt20;
