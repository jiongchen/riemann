...
tt100 = cos(ABC(2,1))
tt101 = cos(tt55)
tt102 = -tt6*tt1*tt53*tt101/8.0-tt6*tt1*tt53*tt100/8.0
tt103 = sin(tt98)
...
tt108 = cos(ABC(2,2))
tt109 = cos(tt66)
tt110 = -tt6*tt1*tt64*tt109/8.0-tt6*tt1*tt64*tt108/8.0
tt111 = sin(tt106)
...
tt116 = cos(ABC(2,3))
tt117 = cos(tt77)
tt118 = -tt6*tt1*tt75*tt117/8.0-tt6*tt1*tt75*tt116/8.0
tt119 = sin(tt114)
...
tt124 = cos(ABC(2,4))
tt125 = cos(tt88)
tt126 = -tt6*tt1*tt86*tt125/8.0-tt6*tt1*tt86*tt124/8.0
tt127 = sin(tt122)
...
tt116 = cos(ABC(2,1))
tt117 = cos(tt59)
tt118 = -tt12*tt1*tt10*tt117/2.0-tt12*tt1*tt10*tt116/2.0
tt119 = sin(tt114)
tt120 = tt113*tt115-tt118*tt119
tt121 = -tt1*tt16*tt7/4.0+tt14*tt5/2.0+tt12*tt11/4.0
tt122 = -tt12*tt1*tt3*tt117/8.0-tt12*tt1*tt3*tt116/8.0
...
tt127 = cos(ABC(2,2))
tt128 = cos(tt74)
tt129 = -tt12*tt1*tt72*tt128/8.0-tt12*tt1*tt72*tt127/8.0
tt130 = sin(tt125)
...
tt135 = cos(ABC(2,3))
tt136 = cos(tt85)
tt137 = -tt12*tt1*tt83*tt136/8.0-tt12*tt1*tt83*tt135/8.0
tt138 = sin(tt133)
...
tt143 = cos(ABC(2,4))
tt144 = cos(tt96)
tt145 = -tt12*tt1*tt94*tt144/8.0-tt12*tt1*tt94*tt143/8.0
tt146 = sin(tt141)
...
&t72/8.0
tt266 = -tt12*tt1*tt19*tt128/2.0-tt12*tt1*tt19*tt127/2.0
...
&t83/8.0
tt307 = -tt12*tt1*tt29*tt136/2.0-tt12*tt1*tt29*tt135/2.0
...
&t94/8.0
tt348 = -tt12*tt1*tt39*tt144/2.0-tt12*tt1*tt39*tt143/2.0
...
tt77 = cos(ABC(2,1))
tt78 = cos(tt65)
tt79 = -tt17*tt2*tt13*tt78/2.0-tt17*tt2*tt13*tt77/2.0
tt80 = sin(tt75)
...
tt159 = -tt17*tt2*tt4*tt78/8.0-tt17*tt2*tt4*tt77/8.0
...
tt164 = cos(ABC(2,2))
tt165 = cos(tt117)
tt166 = -tt17*tt2*tt115*tt165/8.0-tt17*tt2*tt115*tt164/8.0
tt167 = sin(tt162)
...
tt172 = cos(ABC(2,3))
tt173 = cos(tt128)
tt174 = -tt17*tt2*tt126*tt173/8.0-tt17*tt2*tt126*tt172/8.0
tt175 = sin(tt170)
...
tt180 = cos(ABC(2,4))
tt181 = cos(tt139)
tt182 = -tt17*tt2*tt137*tt181/8.0-tt17*tt2*tt137*tt180/8.0
tt183 = sin(tt178)
...
tt232 = 14*tt17*tt4*tt77-2*tt17*tt4*tt78
...
&tt115/8.0
tt322 = -tt17*tt2*tt24*tt165/2.0-tt17*tt2*tt24*tt164/2.0
...
&tt126/8.0
tt366 = -tt17*tt2*tt34*tt173/2.0-tt17*tt2*tt34*tt172/2.0
...
&tt137/8.0
tt410 = -tt17*tt2*tt44*tt181/2.0-tt17*tt2*tt44*tt180/2.0
...
&
tt541 = 14*tt17*tt115*tt164-2*tt17*tt115*tt165
...
&
tt663 = 14*tt17*tt126*tt172-2*tt17*tt126*tt173
...
&
tt774 = 14*tt17*tt137*tt180-2*tt17*tt137*tt181
...
tt19 = 3*ABC(2,1)
tt20 = cos(tt19)
tt21 = -tt5*tt1*tt17*tt20/8.0-tt5*tt1*tt17*tt18/8.0
tt22 = sin(tt15)
...
tt20 = 3*ABC(2,1)
tt21 = cos(tt20)
tt22 = -tt5*tt1*tt18*tt21/8.0-tt5*tt1*tt18*tt19/8.0
tt23 = sin(tt16)
tt24 = sin(tt13)
...
&.0
tt69 = -tt5*tt1*tt3*tt21/2.0-tt5*tt1*tt3*tt19/2.0
...
tt27 = 4*ABC(3,1)
tt28 = cos(tt27)
tt29 = 14*tt9*tt16*tt17-2*tt9*tt16*tt19
tt30 = sin(tt27)
tt31 = sin(tt24)
...
tt67 = -tt9*tt1*tt16*tt19/8.0-tt9*tt1*tt16*tt17/8.0
...
&0
tt83 = -tt9*tt1*tt3*tt19/2.0-tt9*tt1*tt3*tt17/2.0
...
&*tt6/4.0+tt4/2.0+tt2*F(5,1)/4.0)*cos(tt7)-(tt8*tt9-tt8*tt1*tt11)*&
...
&1*F(5,1)/4.0)*tt6-(tt16*tt19-tt16*tt2*tt23)*tt24)/4.0+3.0*(tt1*tt&
&2*tt14/8.0+tt1*tt12/4.0+3.0*F(5,1)/8.0)/8.0-tt2
tt27 = 1/tt15**7
tt28 = 1/tt15**9
...
tt21 = 3*ABC(2,1)
tt22 = sin(tt21)
tt23 = tt18*tt5*tt1*tt19*tt22+3*tt18*tt5*tt1*tt19*tt20
tt24 = sin(ABC(3,1))
...
tt28 = cos(ABC(2,1))
tt29 = cos(tt21)
tt30 = -tt5*tt1*tt19*tt29/8.0-tt5*tt1*tt19*tt28/8.0
tt31 = sin(tt26)
...
tt22 = 3*ABC(2,1)
tt23 = sin(tt22)
tt24 = tt15*tt5*tt1*tt3*tt23+3*tt15*tt5*tt1*tt3*tt21
tt25 = sin(ABC(3,1))
tt26 = -tt15*tt1*tt9*tt18-tt15*tt6*tt16
tt27 = -tt26*tt20
tt28 = 1/tt14**7
tt29 = tt28*tt5*tt1*tt13*tt23+3*tt28*tt5*tt1*tt13*tt21
tt30 = tt29*tt25
...
tt37 = cos(ABC(2,1))
tt38 = cos(tt22)
tt39 = -tt5*tt1*tt3*tt38/2.0-tt5*tt1*tt3*tt37/2.0
tt40 = sin(tt35)
tt41 = -tt1*tt9*tt11/4.0+tt6*tt8/2.0+tt5*tt4/4.0
tt42 = -tt5*tt1*tt13*tt38/8.0-tt5*tt1*tt13*tt37/8.0
...
tt65 = 3*tt28*tt5*tt1*tt13*tt38+3*tt28*tt5*tt1*tt13*tt37
...
tt24 = 3*ABC(2,1)
tt25 = sin(tt24)
tt26 = tt22*tt9*tt1*tt13*tt25+3*tt22*tt9*tt1*tt13*tt23
tt27 = sin(ABC(3,1))
tt28 = tt26*tt27
...
tt37 = tt16*tt9*tt1*tt3*tt25+3*tt16*tt9*tt1*tt3*tt23
...
tt43 = cos(ABC(2,1))
tt44 = cos(tt24)
tt45 = -tt9*tt1*tt13*tt44/8.0-tt9*tt1*tt13*tt43/8.0
tt46 = sin(tt41)
...
&0
tt53 = -tt9*tt1*tt3*tt44/2.0-tt9*tt1*tt3*tt43/2.0
...
tt63 = 7*tt15*tt9*tt13*tt23-3*tt15*tt9*tt13*tt25
...
tt70 = 4*ABC(3,1)
tt71 = cos(tt70)
tt72 = 14*tt9*tt13*tt43-2*tt9*tt13*tt44
tt73 = sin(tt70)
...
tt84 = 3*tt22*tt9*tt1*tt13*tt44+3*tt22*tt9*tt1*tt13*tt43
tt85 = tt84*tt27-tt83*tt20
tt86 = tt30*tt9*tt1*tt13*tt7-tt30*tt9*tt1*tt13*tt5
tt87 = 3*tt16*tt9*tt1*tt3*tt44+3*tt16*tt9*tt1*tt3*tt43
...
tt122 = 7*tt22*tt9*tt13*tt23-27*tt22*tt9*tt13*tt25
...
&2)+2*tt88**2+2*tt85**2+2*tt33*(-tt117*tt27-tt118*tt20)+2*(tt118*t&
&t27-tt117*tt20)*tt29+2*tt82**2+2*tt12*(2*tt9*tt1*tt11*tt7+tt9*tt1&
&0*tt5)
hes(2,3) = tt125
hes(3,1) = tt116
hes(3,2) = tt125
